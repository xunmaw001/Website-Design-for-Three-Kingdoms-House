        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '三国视频名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.shipinName" placeholder="三国视频名称" clearable></el-input>
                     </el-form-item>
                                 
                     <el-form-item :label="contents.inputTitle == 1 ? '三国视频类型' : ''">
                        <el-select v-model="searchForm.shipinTypes" placeholder="请选择三国视频类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/sanguozhijiawangzhan/upload/shipinMuBan.xls"
                        >批量导入三国视频数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shipin','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                   prop="shipinUuidNumber"
                                   header-align="center"
                                   label="三国视频编号">
                        <template slot-scope="scope">
                            {{scope.row.shipinUuidNumber}}
                        </template>
                    </el-table-column>
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '三国视频名称': "shipinName",
                     '三国视频编号': "shipinUuidNumber",
                     '三国视频照片': "shipinPhoto",
                     '三国视频': "shipinVideo",
                     '三国视频类型': "shipinValue",
                     '三国视频热度': "shipinClicknum",
                     '赞': "zanNumber",
                     '踩': "caiNumber",
                     '是否上架': "shangxiaValue",
                     '录入时间': "insertTime",
