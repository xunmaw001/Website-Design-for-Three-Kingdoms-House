...
public class TuwenCollectionView extends TuwenCollectionEntity implements Serializable {
	...
	*/
	...
	private String tuwenCollectionValue;
	...
	public TuwenCollectionView() {

	}

	public TuwenCollectionView(TuwenCollectionEntity tuwenCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, tuwenCollectionEntity);
	...
	* 获取： 类型的值
	*/
	public String getTuwenCollectionValue() {
		return tuwenCollectionValue;
	}
	/**
	* 设置： 类型的值
	*/
	public void setTuwenCollectionValue(String tuwenCollectionValue) {
		this.tuwenCollectionValue = tuwenCollectionValue;
	}
	...
	public String toString() {
		return "TuwenCollectionView{" +
			", tuwenCollectionValue=" + tuwenCollectionValue +
			", tuwenName=" + tuwenName +
